...
const config = {
  ...
  baseUrl: '/docs/vspy3-korean/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'intrepidcs', // Usually your GitHub org/user name.
  projectName: 'vspy3-korean-docs', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          showLastUpdateTime: false, // Show the exact time of the last update
          routeBasePath: '/',
          editUrl:
            'https://github.com/intrepidcs/vspy3-korean-docs/blob/main/',
        },
        // blog: {
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/vspy3-social-card.png',
      navbar: {
        title: 'Vehicle Spy 3 사용자',
        logo: {
          alt: 'Vehicle Spy 3 사용자 Logo',
          src: 'img/logo.svg',
          width: 32,
          height: 32,
